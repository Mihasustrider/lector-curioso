# Generated by Django 5.2.5 on 2025-08-13 22:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(blank=True, help_text='International Standard Book Number', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('gerente', 'Gerente'), ('empleado', 'Empleado')], default='empleado', max_length=10)),
